  ...
  return (
    <div className="space-y-8 pb-40 animate-fade-in">
      ...
      <div className="bg-white rounded-[32px] shadow-soft border border-gray-100 overflow-hidden">
        ...
        >
            <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-purple-50 text-primary flex items-center justify-center group-hover:scale-110 transition-transform">
      ...
      <div className="text-center opacity-30 pt-4">
          <p className="font-black text-2xl tracking-tighter text-gray-400">T TOP CARGO</p>
          <p className="text-[10px] text-gray-400">Version 2.1.0</p>
      </div>
    </div>
  );
};
