        ...
        <div className="bg-white rounded-[32px] overflow-hidden shadow-soft border border-gray-100 animate-slide-up">
            <div className="bg-gray-50 p-6 border-b border-gray-100">
                <div className="flex justify-between items-start">
                    ...
                    <div className={`px-3 py-1 rounded-full text-xs font-bold ${result.boxCode?.toLowerCase().includes('avia') ? 'bg-purple-100 text-primary' : 'bg-orange-100 text-orange-600'}`}>
                    ...
                    {result.history.map((event, i) => {
                        ...
                        return (
                            <div key={i} className="flex gap-4 relative">
                                ...
                                <div className={`w-10 h-10 rounded-full border-4 border-white shadow-sm flex items-center justify-center shrink-0 z-10 ${isArrived ? 'bg-green-100 animate-pulse' : 'bg-purple-50'}`}>
